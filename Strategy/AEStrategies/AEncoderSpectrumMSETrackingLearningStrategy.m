classdef AEncoderSpectrumMSETrackingLearningStrategy < CMStrategy
    ...
    methods
        function obj = AEncoderSpectrumMSETrackingLearningStrategy(name)
            obj@CMStrategy(name);
        end
    end
    ...
    methods 
        function out = execute(obj, cmSystem)
            ...
            if ~strcmp(class(cmSystem), class(AEncoderSpectrumMSETrackingSystem.empty))
