classdef AEncoderSpectrumLearningStrategy < CMStrategy
    ...
    methods
        function obj = AEncoderSpectrumLearningStrategy(name)
            obj@CMStrategy(name);
        end
    end
    ...
    methods 
        function out = execute(obj, cmSystem)
            ...
            if ~strcmp(class(cmSystem), class(AEncoderSpectrumMonitoringSystem.empty))
            ...
            cmSystem.aenMsePlotter.disable();
