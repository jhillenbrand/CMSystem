...
classdef SineGenAcquisitor < DataAcquisitor
    ...
    methods
        ...
        function newData = requestAvailableData(obj)
            ...
            [t, newData1] = SignalAnalysis.noisySine(obj.f_sr, obj.requestSamples, obj.a1, obj.f1, obj.no1, 0, obj.t_0);
            [t, newData2] = SignalAnalysis.noisySine(obj.f_sr, obj.requestSamples, obj.a2, obj.f2, obj.no2, 0, obj.t_0);
