classdef AEncoderAxialBearingSpectrumMonitoringSystem < CMSystem 
...
%             skipWindows = 10; 
            obj.aeDataAcquisitor = AEAsyncAcquisitor(0,false);
                                    %SimStreamAcquisitor(dp, aeFiles, obj.windowSize, skipWindows * obj.windowSize);
            jd = JavaDUX(1, obj.sampleRate, '169.254.138.110', 2020, 'ae_mini_pc', 'aeversuch', '/home/ae_mini_pc/ae/duxToTCPServer');                        
            obj.AEAsyncAcquisitor.setJavaDux(jd);
